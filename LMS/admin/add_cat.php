      ...
      <div class="row">
        ...
        <div class="col-md-4">
            ...
            <div class="form-group text-white">
                   <label>Category ID</lebel>
                   <input type="text" name="cat_id" class="form-control text-white" required=""> 
               </div>
               <div class="form-group text-white">
                   <label>Category Name</lebel>
                   <input type="text" name="cat_name" class="form-control text-white" required=""> 
               </div>
               <button class="btn btn-outline-light" name="add_cat">Add Category</button>
            </form>
        </div>
        <div class="col-md-4"></div>
      </div>    
