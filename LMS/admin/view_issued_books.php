<?php
     ...
     $book_no = "";
     $student_name = "";
	 $query = "select issued_books.book_name,issued_books.book_author,issued_books.book_no,signup.name from issued_books left join signup on issued_books.student_id = signup.id";
...
<table class="table"  style="text-align:center">
  ...
  <thead>
    <tr>
      ...
      <th class="th-lg">Student Name</th>
    </tr>
  </thead>
  <!--Table head-->
