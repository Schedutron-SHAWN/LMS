		...
		<div class="col-md-4">
			<form action="" method="post">
				<div class="form-group text-white">
					<label>Book No:</label>
					<input type="text" name="book_no" value="<?php echo $book_no;?>" class="form-control text-white" required="">
				</div>
				<div class="form-group text-white">
					<label>Book Name:</label>
					<input type="text" name="book_name" value="<?php echo $book_name;?>" class="form-control text-white" required="">
				</div>
				<div class="form-group text-white">
					<label>Author ID:</label>
					<input type="text" name="author_id" value="<?php echo $author_id;?>" class="form-control text-white" required="">
				</div>
				<div class="form-group text-white">
					<label>Category ID:</label>
					<input type="text" name="cat_id" value="<?php echo $cat_id;?>" class="form-control text-white" required="">
				</div>
				<div class="form-group text-white">
					<label>Book Price:</label>
					<input type="text" name="book_price" value="<?php echo $book_price;?>" class="form-control text-white" required="">
				</div>
				<button class="btn btn-outline-light" name="update">Update Book</button>
