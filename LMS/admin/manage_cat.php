...
<meta charset="utf-8">
  ...
  <link rel="stylesheet" type="text/css" href="css/manage_cat.css">
...
<table class="table table-borderd table-hover" style="text-align:center">
  ...
  <thead>
    <tr>
      ...
      <th class="th-lg text-white">Category Name</th>
  ...
  <tbody class="text-white">
     ...
     <?php 
                    ...
                    while($row = mysqli_fetch_assoc($query_run)){
                         ...
                         <td class="text-white"><?php echo $row['cat_name']; ?></td>
                         <td>
                         <button class="btn" name="">
                               <a class="text-white" href="edit_cat.php?cid=<?php echo $row['cat_id']; ?>"><i class="far fa-edit"></i> Edit</a>
                         </button>
                         <button class="btn" name="">
                               <a class="text-white" href="delete_cat.php?cid=<?php echo $row['cat_id']; ?>"><i class="far fa-trash-alt"></i> Delete</a>
                         </button>
                         </td>
                         </tr>
                         <?php 
