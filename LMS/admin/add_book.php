      ...
      <nav class="navbar navbar-expand-lg" style="background-color:#211316;">
       ...
       <br>
		...
		<div class="col-md-4">
			<form action="" method="post">
				<div class="form-group text-white">
					<label>Book ID</label>
					<input type="text" name="book_id" class="form-control text-white" required="">
				</div>
				<div class="form-group text-white">
				...
				<div class="form-group text-white">
					...
					<input type="text" name="author_id" class="form-control text-white" required="">
				</div>

				<div class="form-group text-white">
					<label>Cayegory ID</label>
					<input type="text" name="cat_id" class="form-control text-white" required="">
				</div>
        ...
        <div class="form-group text-white">
					...
					<input type="text" name="book_price" class="form-control text-white" required="">
				</div>
				<button class="btn btn-outline-light" name="add_book" method="post">Add Book</button>
        <br>
			</form>
		</div>
		<div class="col-md-4"></div>
...
<!----------PHP Script For Add Book---------------->
 <?php 
  
     if(isset($_POST['add_book'])){
      $connection = mysqli_connect("localhost","root","");
      $db = mysqli_select_db($connection,"lms");
      $query = "insert into books values($_POST[book_id],'$_POST[book_name]',$_POST[author_id],$_POST[cat_id],$_POST[book_no],$_POST[book_price])";
