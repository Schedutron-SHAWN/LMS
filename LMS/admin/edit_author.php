...
<meta charset="utf-8">
  ...
  <link rel="stylesheet" type="text/css" href="css/edit_author.css">
		...
		<div class="col-md-4">
			<form action="" method="post">
				<div class="form-group text-white">
					...
					<input type="text" name="author_name" value="<?php echo $author_name;?>" class="form-control text-white" required="">
				</div>
				<button class="btn btn-outline-light" name="update">Update Author</button>
