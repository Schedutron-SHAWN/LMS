...
<meta charset="utf-8">
  ...
  <link rel="stylesheet" type="text/css" href="css/add_author.css">
        ...
        <div class="col-md-4">
            <form class="ml-5" action="" method="post">
               <div class="form-group text-white">
                   <label>Author ID</lebel>
                   <input type="text" name="author_id" class="form-control text-white" required=""> 
               </div>
               <div class="form-group text-white">
                   <label>Author Name</lebel>
                   <input type="text" name="author_name" class="form-control text-white" required=""> 
               </div>
               <button class="btn btn-outline-light" name="add_author">Add Author</button>
            </form>
        </div>
        <div class="col-md-4"></div>
      </div>    
